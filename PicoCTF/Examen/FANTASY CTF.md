...
## **Descripcion**
Play this short game to get familiar with terminal applications and some of the most important rules in scope for picoCTF. Connect to the program with netcat: `$ nc verbal-sleep.picoctf.net 51210`
## **Solucion**
Se hizo uso de la terminal
picoCTF{m1113n1um_3d1710n_1e2b417a}

## **Notas adicionales**
se copia el enlace a la terminal despues se presiona enter,nos saldra este un tipo juego con historia
```
┌──(kali㉿kali)-[~]
└─$ nc verbal-sleep.picoctf.net 51210
...
despues va ir siguiendo las instruciones al final nos dara la bandera...