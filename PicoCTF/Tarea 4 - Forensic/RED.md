...
paso 3: usaremos este comando para atraer la cadenas mas largas nos enfocaremos en donde dice text
...
```
Paso 4: Compiamos lo de text y toca decodificar ahi se obtendra la bandera
puede usar cyberchef o este comando
...
picoCTF 2025 - [ Forensic ] - RED https://youtu.be/tbJwWVW6wk8?si=Jn3X_pU9cO1t6Kgh